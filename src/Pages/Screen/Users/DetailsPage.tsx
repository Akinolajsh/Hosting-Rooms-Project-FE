...
import { AiOutlineHeart, AiFillStar, AiOutlineCar } from "react-icons/ai";
import { GoShare, GoShieldLock } from "react-icons/go";
    ...
    <div className="w-full flex justify-center items-center bg-yellow">
      <div className="w-[80%] justify-center items-center flex flex-col ">
        ...
        <div className="w-full justify-center items-center  h-[2500px]">
          <div className="w-[60%] flex flex-col   mt-3 border-b-[1px] border-[#e1e0e0]  bg-green-500 ">
        ...
        <div className=" h-[50px] w-full border-b-[1px] border-[#e1e0e0]"></div>
        {/* About Setup */}
